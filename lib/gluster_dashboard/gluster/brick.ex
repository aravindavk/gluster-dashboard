defmodule GlusterDashboard.Gluster.Brick do
  use Ecto.Schema
  ...
  schema "bricks" do
    ...
    belongs_to :subvols, GlusterDashboard.Gluster.Subvol, [type: :string, foreign_key: :subvols_id]
    belongs_to :peers, GlusterDashboard.Gluster.Peer, [type: :string, foreign_key: :peers_id]
  ...
  def changeset(brick, attrs) do
    ...
    |> validate_required([:path, :state, :block_size, :size_total, :size_used, :inodes_total, :inodes_used, :volumes_id, :subvols_id, :peers_id])
  end
end
