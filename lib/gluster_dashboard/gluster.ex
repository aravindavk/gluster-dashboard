defmodule GlusterDashboard.Gluster do
  @moduledoc """
  The Gluster context.
  """

  import Ecto.Query, warn: false
  alias GlusterDashboard.Repo
  ...
  alias GlusterDashboard.Gluster.Option
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(GlusterDashboard.PubSub, @topic)
  end

  def broadcast_change(event) do
    Phoenix.PubSub.broadcast(GlusterDashboard.PubSub, @topic, {__MODULE__, event})
